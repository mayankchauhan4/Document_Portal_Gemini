...
from src.document_compare.document_comparetor import DocumentComparatorLLM

def load_fake_uploaded_file(file_path:Path):
    return io.BytesIO(file_path.read_bytes())

def test_compare_docuemnts():
    ref_path = Path("C:\\Users\\996ma\\Python_base\\GenAI\\Document_portal\\data\\data_compare\\Long_Report_V1.pdf")
    act_path = Path("C:\\Users\\996ma\\Python_base\\GenAI\\Document_portal\\data\\data_compare\\Long_Report_V2.pdf")
